...
//router.post(':matchid/messages', sendMessage);//zwraca kod statusu i utworzoną wiadomość - jak robimy z ws to nie potrzeb endpointu


//wydaje mi się, że tak łatwiej będzie ogarnąć okienko wyboru chatów z matchy, bo ten 1 endpoint nie ma wartosci z wiadomością żadnej
router.get('/chats', listChats);//zwraca kod statusu, matche przypisane do użytkowika, ostatnią i wiadomość
